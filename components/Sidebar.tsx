    ...
    <aside className="w-60 bg-slate-950 text-slate-300 flex flex-col justify-between p-4 shrink-0 h-screen select-none border-r border-slate-800">
      <div className="space-y-6">
        <div className="flex items-center gap-3 px-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-600 text-white font-black text-xs shadow-sm">
            DM
          </div>
        ...
        <div>
          {role === 'manager' && (
            <p className="mb-2 px-3 text-[9px] font-black uppercase tracking-[0.16em] text-slate-600">Management</p>
          )}
      ...
      <div className="border-t border-slate-800 pt-4">
        <button
          onClick={logout}
          className="flex w-full items-center justify-start gap-2.5 rounded-xl px-3 py-2 text-xs font-bold text-slate-400 transition hover:bg-slate-900 hover:text-rose-400"
        >
